...
#define AFFECTED_BY_NVBUG_5218000 (__CUDACC_VER_MAJOR__ == 12 && (__CUDACC_VER_MINOR__ == 8 or (__CUDACC_VER_MINOR__ == 9 and __CUDACC_VER_BUILD__ <= 41)))
...
// SM89 MMA's require NVCC 12.4
#ifndef CUBLASDX_SUPPORTS_EXTENDED_FP8_MMA
#   define CUBLASDX_SUPPORTS_EXTENDED_FP8_MMA ((__CUDACC_VER_MAJOR__ == 12 && __CUDACC_VER_MINOR__ >= 8) || __CUDACC_VER_MAJOR__ >= 13)
#   if (defined(__CUDA_ARCH__) && (__CUDA_ARCH__ >= 890))
#       define CUBLASDX_ARCH_MMA_EXTENDED_FP8_ENABLED
#   endif
#endif // CUBLASDX_SUPPORTS_EXTENDED_FP8_MMA
