...
namespace commondx {
        ...
        struct is_floating_point {
            static constexpr bool value =
                ...
                COMMONDX_STL_NAMESPACE::is_same_v<T, cutlass::half_t> or
                COMMONDX_STL_NAMESPACE::is_same_v<T, cutlass::tfloat32_t> or
                COMMONDX_STL_NAMESPACE::is_same_v<T, cutlass::bfloat16_t> or
                COMMONDX_STL_NAMESPACE::is_same_v<T, cutlass::float_e5m2_t> or
                COMMONDX_STL_NAMESPACE::is_same_v<T, cutlass::float_e4m3_t> or
#endif
                COMMONDX_STL_NAMESPACE::is_same_v<T, __half> or
                COMMONDX_STL_NAMESPACE::is_same_v<T, __nv_bfloat16> or
                COMMONDX_STL_NAMESPACE::is_same_v<T, cublasdx::tfloat32_t> or
