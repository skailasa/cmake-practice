...
namespace cufftdx {
    namespace detail {
        ...
        __device__ __host__ __forceinline__ constexpr unsigned int get_bluestein_size(const unsigned int fft_size) {
            if (fft_size <= 16) {
                return 32;
            } else if (fft_size <= 32) {
                return 64;
        ...
        __device__ __host__ __forceinline__ constexpr unsigned int get_bluestein_size() {
