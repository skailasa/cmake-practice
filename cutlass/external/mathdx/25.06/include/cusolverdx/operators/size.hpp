...
namespace cusolverdx {
    template<unsigned int M, unsigned int N = M, unsigned int K = 1>
...
namespace commondx::detail {
    ...
    struct is_operator<cusolverdx::operator_type, cusolverdx::operator_type::size, cusolverdx::Size<M, N, K>>:
        COMMONDX_STL_NAMESPACE::true_type {};

    template<unsigned int M, unsigned int N, unsigned int K>
    struct get_operator_type<cusolverdx::operator_type, cusolverdx::Size<M, N, K>> {
